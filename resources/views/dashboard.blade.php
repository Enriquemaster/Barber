<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8 ">
        ...
        <h1 class="text-white p-5 font-bodoni">
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div class="text-center transform transition duration-300 hover:scale-105 h-ful">
                <p class="text-white text-xl font-bodoni p-5">SERVICIOS</p>
            ...
            <div class="text-center transform transition duration-300 hover:scale-105 h-ful">
                <p class="text-white text-xl font-bodoni p-5">PROMOCIONES Y DESCUENTOS</p>
            ...
            <div class="text-center transform transition duration-300 hover:scale-105 h-ful">
                <p class="text-white text-xl font-bodoni p-5">NUESTROS DESAFÍOS</p>
        ...
        <div class=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h2 class="text-3xl font-extrabold font-bodoni text-center text-white mb-8">NUESTROS PRODUCTOS</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-white font-bodoni ">
                <div class="text-center  transform transition duration-300 hover:scale-105 h-ful ">
                    <img src="{{ asset('Products/Pomada-red.png') }}" alt="Pomada Clásica, Capital Grooming, 3.4 oz" class="mx-auto mb-4">
                    <h3 class="text-lg font-medium">POMADA SHAVE FACTORY, COLLAGEN de 150ml</h3>
                    <p class="text-zinc-500">$ 160.00</p>
                </div>
                <div class="text-center  transform transition duration-300 hover:scale-105 h-ful">
                    <img src="{{ asset('Products/Pomada-blue.png') }}" alt="Pomada Mate, Capital Grooming, 3.4 oz" class="mx-auto mb-4">
                    <h3 class="text-lg font-medium">POMADA SHAVE FACTORY, AQUA de 150ml</h3>
                    <p class="text-zinc-500">$ 160.00</p>
                </div>
                <div class="text-center  transform transition duration-300 hover:scale-105 h-ful">
                    <img src="{{ asset('Products/Pomada-green.png') }}"alt="Bálsamo para Barba Aroma Lavanda, Don Porfirio, 80 g" class="mx-auto mb-4">
                    <h3 class="text-lg font-medium">POMADA SHAVE FACTORY, TEA TREE de 150ml</h3>
                    <p class="text-zinc-500">$ 160.00</p>
                </div>
                <div class="text-center  transform transition duration-300 hover:scale-105 h-ful">
                    <img src="{{ asset('Products/Pomada-yellow.png') }}" alt="Bálsamo para Barba, Man's Face Stuff, 3.6oz" class="mx-auto mb-4">
                    <h3 class="text-lg font-medium">POMADA SHAVE FACTORY, ARGAN de 150ml</h3>
                    <p class="text-zinc-500">$ 160.00</p>
                </div>
            </div>
            <div class="text-center mt-8">
                <a href="/productos" class="bg-[#fff4e4] hover:bg-[#aba090] font-bold px-6 py-2 rounded font-bodoni">VER TODOS</a>
            </div>
        </div>
    </div>
    @endrole

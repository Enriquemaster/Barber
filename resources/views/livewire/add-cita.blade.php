<div>
    <button wire:click="$toggle('modal')" class=" absolute text-black text-xl rounded-md px-5 bg-yellow-600 hover:bg-yellow-800 font-bold focus:outline-none focus:ring focus:border-blue-100 md:px-10 md:py-2 Bodoni left-1/2 top-20 md:top-40 md:left-1/2 transform -translate-x-1/2">
        Agregar cita
    </button>

  ...
  <div class="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-4">
   ...
   <div class="flex flex-col space-y-4 ">
        <div class="bg-zinc-800 p-4 rounded-lg flex items-center justify-center">
          <div>
            <h3 class="text-amber-400 text-2xl bg-gradient-to-b from-amber-300 via-yellow-600 to-slate-100 bg-clip-text text-transparent font-bold" id="Eslogan3">Registro del servicio</h3>
          </div>
        </div>
    <form method="post" action="{{ route('registrar-servicio') }}"  class="relative z-10" enctype="multipart/form-data">
                  ...
                  <h1 class="p-2 text-amber-400 text-4xl font-normal" id="barbero" >Datos del servicio</h1>
                    
                  </div>
                      <div class=" mr-2 mt-2">
                          <label for="nombre" class="block text-lg italic font-sans-serif text-amber-400" id="contenido">Nombre del corte</label>

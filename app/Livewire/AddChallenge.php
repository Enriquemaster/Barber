...
class AddChallenge extends Component
{
    ...
    public function save()
    {
        ...
        $challenge->imagen = $imagePath ?? null; // Guarda la URL de la imagen si existe
        $challenge->save();
...
<div>
    ...
    <x-confirmation-modal wire:model="modal">
        ...
        <img src="{{ asset('Icons/LogoB.png') }}" alt="login" class="object-cover w-1/4 h-1/4" />
            <h1 class="text-2xl font-bold text-white">Agregar un reto</h1>
        </x-slot:title>
        <x-slot:content>
        ...
        <x-slot:footer>
            <div class="flex items-center justify-center">
                <x-button wire:click="confirmarReto()" class="px-4 py-2">Agregar reto</x-button>
            </div>
        </x-slot:footer>
